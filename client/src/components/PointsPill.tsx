...
export default function PointsPill() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3.5 h-9 rounded-full bg-brand-brown text-white shadow-md active:scale-95 transition-transform"
    >
      <Coins size={15} className="text-brand-orange" />
