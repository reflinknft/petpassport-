      ...
      <div className="px-5 -mt-10 relative">
        <div className="paper-card p-5 journal-enter">
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-black text-brand-ink flex items-center gap-2">
                {pet.name}
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-brand-lilac flex items-center justify-center text-brand-ink active:scale-95 transition-transform"
              aria-label="編輯"
            >
              <Pencil size={16} />
            </button>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between text-xs">
              <span className="font-bold text-brand-ink">照護資料完整度</span>
              <span className="font-extrabold text-brand-purple tabular">{pet.completeness}%</span>
            </div>
            <div className="mt-2 h-2 rounded-full bg-brand-lilac overflow-hidden">
              <div className="h-full rounded-full bg-brand-purple" style={{ width: `${pet.completeness}%` }} />
            </div>
          ...
          <div className="mt-4 flex gap-1.5 flex-wrap">
            {pet.tags.map((t) => (
              <span key={t} className="text-[11px] font-bold px-2.5 py-1 rounded-full bg-brand-lilac text-brand-ink">{t}</span>
            ))}
          </div>
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-brand-purple-dark flex items-center justify-center shrink-0">
            <IdCard size={18} className="text-brand-purple" />
          </div>
          <div className="text-left">
            <p className="text-sm font-bold text-brand-ink">電子寵物卡</p>
        ...
        {/* 相關任務 */}
        <h2 className="mt-6 font-black text-brand-ink">與 {pet.name} 相關的任務</h2>
        ...
        <div className="mt-6 mb-8 passport-frame p-4 flex gap-3 bg-white/60">
          <ShieldCheck size={18} className="text-brand-mint shrink-0 mt-0.5" />
