...
export default function Splash() {
  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center bg-brand-cream px-8">
      ...
      <h1 className="mt-6 text-3xl font-black text-brand-brown journal-enter">毛孩護照</h1>
      <p className="mt-1 text-sm font-bold text-brand-orange journal-enter journal-enter-1">Pet Passport</p>
